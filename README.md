...
# agent clones a repo with a compromised dependency
```
...
before your agent acts on any external context, make a single call. brin returns a score, verdict, and any detected threats. if brin is unreachable, the agent continues as normal — zero risk to your existing workflow.
...
if your agent can reach it, brin scores it.
