...
/// Run the add command
pub async fn run(client: &SusClient, packages: Vec<String>, yolo: bool, strict: bool) -> Result<()> {
...
mod tests {
    ...
    fn test_parse_package_spec() {
        ...
        assert_eq!(parse_package_spec("lodash@4.17.0"), ("lodash", Some("4.17.0")));
